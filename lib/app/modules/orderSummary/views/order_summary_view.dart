...
class OrderSummaryView extends GetView<OrderSummaryController> {
  ...
  Widget build(BuildContext context) {
    return Obx(() {
      return ProgressHud(buildUi(context), orderSummaryController.isLoading.value);
    });
  }
  ...
  Widget buildUi(BuildContext context) {
        ...
        children: [
          Obx(() {
            return Center(
                child: InkWell(
                  onTap: () {
                    if (cartController.cartValue.value < orderSummaryController.walletBal.value) {
                      orderSummaryController.checkOut();
                    } else if (cartController.cartValue.value >= 1000) {
                      Get.snackbar(
                        'Error',
                        'Total value should be less than 1000',
    ...
    return RefreshIndicator(
      ...
      onRefresh: () async {
        ...
        orderSummaryController.getWalletBal();
      },
      child: Scaffold(
                        ...
                        children: [
                          Column(
                            ...
                            children: [
                                                  ...
                                                  Row(
                                                    ...
                                                    children: [
                                                      ...
                                                      Expanded(
                                                        ...
                                                        child: InkWell(
                                                          onTap: () {
                                                            if (kDebugMode) {print('Amount-${orderSummaryController.walletBalance.text}');}
                                                            if(orderSummaryController.walletBalance.text.isEmpty){
                                                              Get.snackbar('Wallet Error', 'Please fill the correct amount',
                                                                  snackPosition: SnackPosition.BOTTOM,
                                                                  colorText: Colors.black,
                                                                  backgroundColor: Colors.yellow);
                                                            }else{
                                                              orderSummaryController.openCheckout(int.parse(orderSummaryController.walletBalance.text));
                                                            }
                                                            Get.back();
                                                          },
                                                          child: Container(
                              ...
                              Obx(() {
                                return Text('₹ ${orderSummaryController.walletBal}/-',
                                  style: titleStyle,);
                              })
                            ],
                          ),
