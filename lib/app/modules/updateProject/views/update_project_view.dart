...
class UpdateProjectView extends GetView<UpdateProjectController> {
  @override
  UpdateProjectController controller = Get.put(UpdateProjectController());

  UpdateProjectView({super.key});
  ...
  Widget buildUi(BuildContext context) {
    ...
    final appBar = Stack(
      ...
      children: [
        const Center(child: Text('Update Project',style: titleStyle,)),
        //Back Button
        Align(
                        ...
                        children: [
                              ...
                              child: InkWell(
                                ...
                                child: Container(
                                    ...
                                    child: controller.sketch.value != ''
                                        ? ClipRRect(
                                        borderRadius: BorderRadius.circular(10),
                                        child: Image.file(File(controller.sketch.value),fit: BoxFit.cover))
                                        : Image.network(ApiServices().projectImageURl + controller.data[3],fit: BoxFit.cover,)
                                        // : const Center(child: Text('Tap To Select\nProject Thumbnail', textAlign: TextAlign.center, style: subTitle,))
                                ),
                              ),
                            );
                          }),
                                    ...
                                    child: Center(
                                      ...
                                      return Row(
                                        ...
                                        children: [
                                          ...
                                          Text(controller.startDate.value == DateFormat('yyyy-MM-dd').format(DateTime.now())
                                            ? DateFormat('yyyy-MM-dd').format(controller.data[4])
                                            : controller.startDate.value, style: blueButtonSubTitle,),
                                        ],
                                      );
                                    })),),
                                  ),
                                      ...
                                      return Row(
                                        ...
                                        children: [
                                          const Icon(
                                            ...
                                            color: Colors.white,),
                                          //SizedBox(width: 5,),
                                          Text(controller.endDate.value == DateFormat('yyyy-MM-dd').format(DateTime.now())
                                              ? DateFormat('yyyy-MM-dd').format(controller.data[5])
                                              : controller.endDate.value, style: blueButtonSubTitle,),
                                        ],
                                      );
                                    })),),
                                  ),
                          ...
                          Container(
                            ...
                            child: Center(child: InkWell(
                              onTap: (){
                                controller.updateProject(controller.data[0].toString());
                              },
                              child: const Text('UPDATE PROJECT',style: blueButtonSubTitle),
                            ),),
                          ),
                          SizedBox(height: size.width * 0.05,),
                          //----Upload-Video----
                          Container(
                            ...
                            child: Center(child: InkWell(
                              onTap: (){
                                controller.pickVideo(controller.data[0].toString());
                              },
                              child: const Text('UPLOAD VIDEO',style: blueButtonSubTitle),
                            ),),
                          ),
                        ],
                      ),
